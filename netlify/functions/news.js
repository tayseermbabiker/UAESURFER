...
<body>
  ...
  <div class="container">
    ...
    <div class="source-box">
      <p>This update was originally reported by <strong>${sourceName}</strong>. Read the full article on their site.</p>
      <a href="${sourceUrl}" target="_blank" rel="noopener" class="source-link">Read Full Article on ${sourceName}</a>
    </div>
    <div class="related">
